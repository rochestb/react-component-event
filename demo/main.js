...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactEvent = __webpack_require__(159);

	var _reactEvent2 = _interopRequireDefault(_reactEvent);
	...
	var Grandson = function (_React$Component) {
	  _inherits(Grandson, _React$Component);

	  function Grandson(props) {
	    _classCallCheck(this, Grandson);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Grandson).call(this, props));

	    (0, _reactEvent2.default)(_this);
	    return _this;
	  }

	  _createClass(Grandson, [{
	    key: 'wrapClickHandler',
	    value: function wrapClickHandler() {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'button',
	        { className: 'grandson', onClick: function onClick(event) {
	            _this2.emit();
	          } },
	        this.props.children
	      );
	...
	var Child = function (_React$Component2) {
	  ...
	  function Child(props) {
	    ...
	    var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(Child).call(this, props));

	    (0, _reactEvent2.default)(_this3);
	    return _this3;
	  }
	  ...
	  _createClass(Child, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.on('WrapClick', function (event) {
	        if (_this4.props.index === 1) {
	          event.stopPropagation();
	        }
	        _this4.emit('WrapClick');
	      });
	    }
	  }, {
	    key: 'render',
	...
	var Wrap = function (_React$Component3) {
	  _inherits(Wrap, _React$Component3);

	  function Wrap(props) {
	    _classCallCheck(this, Wrap);

	    var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(Wrap).call(this, props));

	    (0, _reactEvent2.default)(_this5, {
	      isRoot: true
	    });
	    _this5.state = {
	      count: []
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'div',
	                null,
	                this.state.count.map(function (index) {
	                  return _react2.default.createElement(Child, { key: index, index: index });
	                })
	              )
	            )
	          )
	...
	(0, _reactDom.render)(_react2.default.createElement(Wrap, null), document.getElementById('example'));
